  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">GoldenTradeValue - Borrar Clientes</h5>
      ...
      <div class="modal-body">
        <form>
          <p class="font-weight-light">Borrar el cliente no altera la información generada por alguna de sus acciones  desde su generación compra, ventas, existencias no se verán afectadas después de su borrado.</p>
